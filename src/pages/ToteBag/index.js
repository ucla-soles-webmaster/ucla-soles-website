...
class ToteBag extends Component {
    ...
    sendEmail = (e) => {
        ...
        this.props.firebase.getFirestore().collection("misc")
            .doc('tote_count')  // can have multiple .where calls
            .update({
            standard: that.state.tote_count - that.state.quantity_form
        })
                ...
                <div class="itemPageOutmostDiv" style={{marginTop: "3vw"}}>
                    ...
                    <div class="itemPageFlex2" style={{marginRight: "0%", marginLeft: "5vw"}}>
                        ...
                        <ul style={{color: "#6f7571"}}>
                            <li style={{fontSize: "1.05em"}}>Tan tote bag with Olvera St. graphic!</li>
                        </ul>
                        ...
                        <form ref={this.state.form} onSubmit={this.sendEmail} className="itemOrderForm">
                            ...
                            <br/>
                            <input style={{fontSize: "0%", border: "none"}} name="item" value="SOLES Tote Bag"/>
