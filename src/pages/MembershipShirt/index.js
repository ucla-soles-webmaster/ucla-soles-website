...
import front1 from '../../Photos/MerchShop/Shirt22-23/front.png';
import back1 from '../../Photos/MerchShop/Shirt22-23/back.png';
                ...
                <div class="itemPageOutmostDiv" style={{marginTop: "3vw"}}>
                    ...
                    <div class="itemPageFlex2" style={{marginRight: "0%", marginLeft: "5vw"}}>
                        ...
                        <ul style={{color: "#6f7571"}}>
                            <li style={{fontSize: "1.05em"}}>The SOLES membership shirt for the 2022-2023 school year.</li>
                            {/*}
