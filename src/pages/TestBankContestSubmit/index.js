...
*/
        ...
        */
        ...
        var delayInMilliseconds = 4000; // 10 second
        ...
        // Store filename/reference on Firestore
            that.props.firebase.getFirestore().collection('tests').doc(that.state.department).collection('classes').doc(that.state.classID).collection('tests').doc(storageName).set({
                ...
                contest: true,
                user_submitted: that.state.submitter_email,
                from: {
            ...
            // add point to user on leaderboard
            // Increment submitters test count 
            ...
            // add test name to users doc collection
            var testsName = "" + that.state.department + that.state.classID + that.state.testType + that.state.testQuarter + that.state.professor + storageName
            that.props.firebase.getFirestore().collection("misc").doc("test_submitters").collection("test_submitters").doc(that.state.submitter_name).collection("tests").add({
                test: testsName
            })
                .then(function() {
                console.log("Document successfully written!");
            ...
            */
            ...
            if (that.state.submitter_email != '') {
                ...
                that.props.firebase.getFirestore().collection("users")
                    ...
                    .then(function(querySnapshot) {
                        querySnapshot.forEach(function(doc) {
                            console.log("FOUND EMAIL/USER for PASSES")
                            var new_passes = doc.data()["testbank_passes"] + 1
                            that.props.firebase.getFirestore().collection('users').doc(doc.id).update({
                                testbank_passes: new_passes
                            });
        ...
        return (
            <div className="graa" style={{minHeight: "150vh"}}> 
                ...
                <div className="navgapA" style={{minHeight: "150vh"}}>
                    ...
                    <h1 className="haccount" style={{marginBottom: '1.2vw'}}>
                        Test Bank Submission Contest 
                    </h1>

                    <div style={{fontFamily:'Poppins', margin: 'auto', width: '50%', textAlign: 'center', fontSize: '1.2rem'}}>
                        1st Place: <b style={{color: 'green'}}>$50</b> &nbsp;&nbsp;
                        2nd Place: <b style={{color: 'green'}}>$30</b> &nbsp;&nbsp;
                        3rd Place: <b style={{color: 'green'}}>$20</b> 
                        <p style={{fontSize: '1rem', marginTop: '0.1rem'}}>Competition ends W'22 Finals Week.</p>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="hubbox">
                                    ...
                                    <p className="hubintroTS">
                                        <br/>
                                        Submit a test below: <br/>
                                        (note: we will monitor sumbmissions for fake submissions lol)
                                    </p>
                                            ...
                                            { this.state.uploadProgress !== 100 ? <div>
                                                ...
                                                <div className="checksu" style={{paddingTop: '1%'}}>
                                                    ...
                                                    <input 
                                                        ...
                                                        placeholder={"Eggert"} 
                                                        onChange={(e) => {
                                                            this.setState({ submitter_name: e.target.value })
                                                        }}
                                                        className="FormRowLabelDropDownTS"
                                                    />
                                                ...
                                                <div className="checksu">
                                                    ...
                                                    <input 
                                                        label={"Email"}
                                                        type="text"
                                                        placeholder={"INSERT IF YOU WANT TEST PASS for your account"} 
                                                        onChange={(e) => {
                                                            this.setState({ submitter_email: e.target.value })
                                                        }}
                                                        className="FormRowLabelDropDownTS"
                                                    />
                                                            ...
                                                            { this.state.uploadProgress === 100
                                                                ?
                                                                    <p className="uploadSuccess">
                                                                        ...
                                                                        <br/>
                                                                        <br/>
                                                                        Refresh page to reflect leaderboard changes. <br/>
...
export default withAuthorization(condition)(TestBankContestSubmit);
