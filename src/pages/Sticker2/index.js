...
import pic1 from '../../Photos/MerchShop/Sticker2/pic1.png';
import pic2 from '../../Photos/MerchShop/Sticker2/pic2.jpg';
import pic3 from '../../Photos/MerchShop/Sticker2/pic3.jpg';
import pic4 from '../../Photos/MerchShop/Sticker2/pic4.jpg';
import pic5 from '../../Photos/MerchShop/Sticker2/pic5.jpg';
...
class Sticker2 extends Component {
    ...
    componentDidMount() {
        ...
        this.props.firebase.getFirestore().collection("misc").doc("sticker_counts")
        .get()
        .then(function(doc) {
            if (doc.exists) {
    ...
    sendEmail = (e) => {
        ...
        this.props.firebase.getFirestore().collection("misc").doc("orders").collection("orders_stickers2").doc(order_doc_name).set({
        ...
        this.props.firebase.getFirestore().collection("misc")
            .doc('sticker_counts')  // can have multiple .where calls
            .update({
                ...
                <div class="itemPageOutmostDiv" style={{marginTop: "3vw"}}>
                    ...
                    <div class="itemPageFlex2" style={{marginRight: "0%", marginLeft: "5vw"}}>
                        ...
                        <ul style={{color: "#6f7571"}}>
                            <li style={{fontSize: "1.05em"}}>Retro styled limited stock sticker.</li>
                        </ul>
                        ...
                        <form ref={this.state.form} onSubmit={this.sendEmail} className="itemOrderForm">
                            ...
                            <br/>
                            <input style={{fontSize: "0%", border: "none"}} name="item" value="Sticker 2"/>
...
export default withAuthorization(condition)(Sticker2);
