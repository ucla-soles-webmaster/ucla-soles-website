...
class LogoShirt extends Component {
    ...
    sendEmail = (e) => {
        ...
        this.props.firebase.getFirestore().collection("misc").doc("orders").collection("orders_logos_comp").doc(order_doc_name).set({
            name: that.state.name_form,
            email: that.state.email_form,
            quantity: that.state.quantity_form,
            size: that.state.size_form,
            date: order_date,
            item: "Logo Comp Shirt"
          })
            .then(function() {
                ...
                <div class="itemPageOutmostDiv" style={{marginTop: "3vw"}}>
                    ...
                    <div class="itemPageFlex2" style={{marginRight: "0%", marginLeft: "5vw"}}>
                        ...
                        <ul style={{color: "#6f7571"}}>
                            <li style={{fontSize: "1.05em"}}>Designed by the one and only Robert Valencia!</li>
                            <li style={{fontSize: "1.05em"}}>Keith Haring inspired</li>
                        </ul>
                        ...
                        <form ref={this.state.form} onSubmit={this.sendEmail} className="itemOrderForm">
                            ...
                            <br/>
                            <input style={{fontSize: "0%", border: "none"}} name="item" value="SOLES Logo Competition Shirt"/>
                        </form>
...
export default withAuthorization(condition)(LogoShirt);